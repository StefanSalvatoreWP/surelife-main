...
<body
    class="bg-gradient-to-br from-primary-50 via-white to-primary-100 min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-6xl">
        <div class="grid md:grid-cols-2 gap-8 bg-white rounded-2xl shadow-2xl overflow-hidden">

            <!-- Left Side - Branding -->
            <div
                class="bg-white border-2 border-primary-400 p-12 flex flex-col items-center justify-center text-gray-800 relative overflow-hidden">
                <div class="relative z-10 text-center">
                    <div class="mb-8 transform hover:scale-105 transition duration-300">
                        <img src="{{ asset('images/Surelife.png')}}" alt="SLC Logo"
            ...
            <div class="p-12 flex flex-col justify-center">
                ...
                <form action="/login" method="POST" class="space-y-6" id="loginForm">
                    ...
                    <!-- Name Disambiguation Fields (right below username, shown when duplicate contract detected) -->
                    <div id="nameFields" class="{{ session('needs_name') ? '' : 'hidden' }}">
                        <div class="mb-3 bg-blue-50 border-l-4 border-blue-500 p-3 rounded-lg">
                            <div class="flex items-center">
                                ...
                                <p class="text-blue-700 text-sm font-medium">Multiple accounts found. Enter your name to identify your account.</p>
                            </div>
                        </div>
                        <div class="grid grid-cols-2 gap-3">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" id="firstName" name="firstname" class="input-field pl-10"
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" id="lastName" name="lastname" class="input-field pl-10"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="accessKey" name="accesskey"
                                ...
                                placeholder="Enter your access key" value="{{ old('accesskey') }}">
                        </div>
                        @error('accesskey')
                            <p class="mt-2 text-sm text-red-600 flex items-center">
                                <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
