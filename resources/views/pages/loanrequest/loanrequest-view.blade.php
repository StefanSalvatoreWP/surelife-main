...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8">
    ...
    <div class="bg-white rounded-xl border-2 border-blue-300 p-6 mb-6">
        ...
        <div class="mt-4 flex flex-wrap gap-2">
            ...
            <a href="/client-view/{{ $clientDetails->Id }}#loan" class="inline-flex items-center px-4 py-2 bg-blue-500 hover:bg-blue-700 text-white text-sm font-medium rounded transition-colors min-h-[44px]">
                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
