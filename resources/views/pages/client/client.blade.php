...
@section('content')
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <!-- MODAL DELETE -->
        <div class="modal fade" id="clientDeleteModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true" style="display: none;">
                    ...
                    <div class="modal-body p-6">
                        <div class="flex items-start mb-4">
                            ...
                            <div class="ml-4 flex-1">
                                <p class="text-gray-800 font-semibold mb-2">Delete selected client? <span class="text-red-600 font-bold" id="clientToDelete"></span></p>
                                <p class="text-gray-600 text-sm">This action cannot be undone. The client and all associated data will be permanently removed from the system.</p>
                            </div>
                        </div>
                    </div>
