...
@section('styles')
    <link rel="stylesheet" href="{{ asset('css/barangay.css') }}?v={{ time() }}">
@endsection
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-white rounded-xl border-2 border-green-300 p-6 mb-6">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-green-800 mb-2">Barangay Management</h1>
                    <p class="text-green-600 text-sm">Manage different barangays based on cities</p>
                </div>
        ...
        <!-- Action Button -->
        <div class="mb-6">
            <a href="/barangay-create" class="inline-flex items-center px-6 py-3 bg-emerald-600 hover:bg-emerald-700 text-white font-semibold rounded-lg shadow-md hover:shadow-lg transform hover:scale-105 transition duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2">
        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
                <h3 class="text-lg font-semibold text-gray-800">Barangay List</h3>
            </div>
                ...
                <table id="common_dataTable" class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-4 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Barangay</th>
        ...
        <!-- MODAL DELETE -->
        <div class="modal fade" id="barangayDeleteModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true" style="display: none;">
                    ...
                    <div class="modal-body p-6">
                        <div class="flex items-start mb-4">
                            ...
                            <div class="ml-4 flex-1">
                                <p class="text-gray-800 font-semibold mb-2">Delete selected barangay? <span class="text-red-600 font-bold" id="barangayToDelete"></span></p>
                                <p class="text-gray-600 text-sm">This action cannot be undone. The barangay and all associated data will be permanently removed from the system.</p>
                            </div>
                        </div>
                    </div>
