    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-white rounded-xl border-2 border-green-300 p-6 mb-6">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-green-800 mb-2">Packages</h1>
                    <p class="text-green-600 text-sm">Manage different content packages</p>
                </div>
        ...
        <!-- Action Button -->
        <div class="mb-6">
            <a href="/package-create" class="inline-flex items-center px-6 py-3 bg-pink-600 hover:bg-pink-700 text-white font-semibold rounded-lg shadow-md hover:shadow-lg transform hover:scale-105 transition duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-pink-500 focus:ring-offset-2">
        ...
        <!-- MODAL DELETE -->
        <div class="modal fade" id="packageDeleteModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true" style="display: none;">
                ...
                <div class="modal-content rounded-xl shadow-2xl border-0">
                    ...
                    <div class="modal-body p-6">
                        <div class="flex items-start mb-4">
                            ...
                            <div class="ml-4 flex-1">
                                <p class="text-gray-800 font-semibold mb-2">Delete selected package? <span class="text-red-600 font-bold" id="packageToDelete"></span></p>
                                <p class="text-gray-600 text-sm">This action cannot be undone. The package will be permanently removed from the system.</p>
                            </div>
                        </div>
                    </div>
                    <form id="deleteForm" method="POST">
                        ...
                        <div class="modal-footer border-0 p-6 pt-0">
                            ...
                            <button type="button" class="px-6 py-2.5 bg-red-50 hover:bg-red-100 text-red-900 font-semibold rounded-lg shadow-md hover:shadow-lg transition duration-200 ease-in-out" id="confirmDelete">Delete Package</button>
                        </div>
                    </form>
                </div>
            </div>
