...
@section('styles')
    <link rel="stylesheet" href="{{ asset('css/region.css') }}?v={{ time() }}">
@endsection
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-white rounded-xl border-2 border-green-300 p-6 mb-6">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-green-800 mb-2">Region Management</h1>
                    <p class="text-green-600 text-sm">Manage different content regions</p>
                </div>
        ...
        <!-- Action Button -->
        <div class="mb-6">
            <a href="/region-create" class="inline-flex items-center px-6 py-3 bg-cyan-600 hover:bg-cyan-700 text-white font-semibold rounded-lg shadow-md hover:shadow-lg transform hover:scale-105 transition duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:ring-offset-2">
        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
                <h3 class="text-lg font-semibold text-gray-800">Region List</h3>
            </div>
        ...
        <!-- MODAL DELETE -->
        <div class="modal fade" id="regionDeleteModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true" style="display: none;">
                    ...
                    <div class="modal-body p-6">
                        <div class="flex items-start mb-4">
                            ...
                            <div class="ml-4 flex-1">
                                <p class="text-gray-800 font-semibold mb-2">Delete selected region? <span class="text-red-600 font-bold" id="regionToDelete"></span></p>
                                <p class="text-gray-600 text-sm">This action cannot be undone. The region and all associated data will be permanently removed from the system.</p>
                            </div>
                        </div>
                    </div>
