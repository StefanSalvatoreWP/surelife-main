...
@section('content')
            ...
            <div class="p-6">
                <div class="max-w-2xl">
                    ...
                    <div class="mt-8 flex justify-center">
                        <button type="button" onclick="showDeleteBankModal()" class="inline-flex items-center px-8 py-3 bg-red-50 hover:bg-red-100 text-red-900 font-semibold rounded-lg shadow-md hover:shadow-lg transform hover:scale-105 transition duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-red-200 focus:ring-offset-2">
    ...
    <script>
        function showDeleteBankModal() {
            ...
            showSwiftModal('Confirm Deletion', `Delete selected bank "${selectedBank}"?\n\nAll accounts will also be deleted. This action cannot be undone.`, 'warning', [
                {text: 'Delete Bank', class: 'bg-red-500 hover:bg-red-600 text-white', action: 'submitDeleteBank()'},
                {text: 'Cancel', class: 'bg-gray-200 hover:bg-gray-300 text-gray-800'}
            ]);
        }
        
        function submitDeleteBank() {
            const bankId = document.getElementById('bankName').value;
            
            const form = document.createElement('form');
            form.method = 'POST';
            form.action = '/bank-delete/' + bankId;
