    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-white rounded-xl border-2 border-green-300 p-6 mb-6">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-green-800 mb-2">Roles</h1>
                    <p class="text-green-600 text-sm">Manage role levels</p>
                </div>
        ...
        <!-- Action Button -->
        <div class="mb-6">
            <a href="/role-create" class="inline-flex items-center px-6 py-3 bg-purple-600 hover:bg-purple-700 text-white font-semibold rounded-lg shadow-md hover:shadow-lg transform hover:scale-105 transition duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2">
                ...
                <table id="common_dataTable" class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-4 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Level</th>
        ...
        <!-- MODAL DELETE -->
        <div class="modal fade" id="roleDeleteModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true" style="display: none;">
                ...
                <div class="modal-content rounded-xl shadow-2xl border-0">
                    ...
                    <div class="modal-body p-6">
                        <div class="flex items-start mb-4">
                            ...
                            <div class="ml-4 flex-1">
                                <p class="text-gray-800 font-semibold mb-2">Delete selected role? <span class="text-red-600 font-bold" id="roleToDelete"></span></p>
                                <p class="text-gray-600 text-sm">This action cannot be undone. The role will be permanently removed from the system.</p>
                            </div>
                        </div>
                    </div>
                    <form id="deleteForm" method="POST">
                        ...
                        <div class="modal-footer border-0 p-6 pt-0">
                            ...
                            <button type="button" class="px-6 py-2.5 bg-red-50 hover:bg-red-100 text-red-900 font-semibold rounded-lg shadow-md hover:shadow-lg transition duration-200 ease-in-out" id="confirmDelete">Delete Role</button>
                        </div>
                    </form>
                </div>
            </div>
