...
$(document).ready(function() {
        ...
        columns: [
            ...
            { data: 'RegionName', name: 'tblregion.RegionName' },
            {
                ...
                render: function (data, type, row) {
                    var updateLink = '<a href="/branch-update/' + data.Id + '" class="action-btn action-btn-update">' +
                    ...
                    var deleteLink = '<a href="#" data-branch-id="' + data.Id + '" data-branch-name="' + data.BranchName + '" class="action-btn action-btn-delete">' +
                        '<svg class="action-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">' +
    ...
    $(document).on('click', '.action-btn-delete', function(e) {
        ...
        $('#branchToDelete').text(branchName);
        ...
        $('#confirmDelete').on('click', function() {
            ...
            deleteForm.attr('action', '/submit-branch-delete/' + branchId);
            deleteForm.submit();
        });
        
        // Show the modal
        let modal = $('#branchDeleteModal');
