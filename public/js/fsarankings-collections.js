...
$(document).ready(function () {
    ...
    var loadedTable = $('#common_dataTable').DataTable({
        ...
        language: {
            processing: '<div class="slc-spinner-card"><div class="slc-rings"><div class="slc-ring-outer"></div><div class="slc-ring-mid"></div><div class="slc-ring-dot"></div></div><div class="slc-label">Loading<div class="slc-dots"><span></span><span></span><span></span></div></div><div class="slc-bar"></div></div>',
